function rendering( volume, isovalue, screen, reflection_type )
{
    ...
    else{var material = new THREE.ShaderMaterial({
                                                 vertexColors: THREE.VertexColors,
    ...
    function interpolated_vertex( v0, v1, s )
    {
        ...
        var scalar = (s-s0)/(s1-s0);
        var vsub = new THREE.Vector3().subVectors(v1, v0);
        var vmid = new THREE.Vector3().addScaledVector(vsub,scalar);
        return new THREE.Vector3().addVectors( v0, vmid )
    }
}
